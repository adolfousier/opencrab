...
| **Dynamic Brain System** | System brain assembled from workspace MD files — all editable live between turns. Files can declare a custom description via YAML frontmatter (`description:` field) which replaces the hardcoded description in the context-file index |
