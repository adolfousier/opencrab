//! [`GenerateDocumentTool`]: the `generate_document` surface, its
//! validation and the per-format dispatch to the native backends.

use super::super::error::{Result, ToolError};
use super::super::r#trait::{Tool, ToolCapability, ToolExecutionContext, ToolResult};
use super::input::GenerateDocumentInput;
use super::{docx, pdf, pptx, schema, xlsx};
...
impl Tool for GenerateDocumentTool {
    ...
    async fn execute(&self, input: Value, context: &ToolExecutionContext) -> Result<ToolResult> {
        ...
        let path = super::super::error::resolve_tool_path(&input.output, &context.working_dir());
